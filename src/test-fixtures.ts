...
import {NewMessageInput} from "./generated/graphql";

const input1: [NewMessageInput] =
    [
        ...
        githubData: {
            ...
            repository:
                { id: 355514042,
                    ...
                    owner: {
                        name: 'johnsmith',
                        email: 'johnsmith@users.noreply.github.com',
                        login: 'johnsmith',
                        id: 59977873,
                    ...
                    git_url: 'git://github.com/johnsmith/ppldo-task.git',
                    ssh_url: 'git@github.com:johnsmith/ppldo-task.git',
            ...
            pusher:
                { name: 'johnsmith',
                    email: '59977873+johnsmith@users.noreply.github.com' },
            sender:
                { login: 'johnsmith',
                    id: 59977873,
                    node_id: 'MDQ6VXNlcjU5OTc3ODcz',
            ...
            head_commit:
                { id: '0a8953c3d55c527028233c63392052e6aa0f2c44',
                    ...
                    added: [],
                    removed: [],
                    modified: [ 'src/services/github/event-parser.ts' ]
                }
        },
        result: {
            query: '',
