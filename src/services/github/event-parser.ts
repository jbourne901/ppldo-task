import {IGithubCommit, IGithubEventPayload, IGithubPushDate} from "../../interfaces/github";
...
/**
 * Отвечает за обработку сырого события от github,  выделение из него полезных полей,
